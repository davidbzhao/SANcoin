...
./cryptomoney.sh fund $BOB 100 test/transaction3.txt
./cryptomoney.sh transfer test/alice.wallet $BOB 25 test/transaction4.txt
...
./cryptomoney.sh verify test/alice.wallet test/transaction4.txt
